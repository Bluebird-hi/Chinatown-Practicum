...
-   **Philadelphia:** We look at properties within the city of Philadelphia to conduct the first step of our highway analysis.
-   **Main study area (10 block groups):** Incorporating block groups from Chinatown, Callowhill, Logan Square, Center City East, Old City, and West Poplar, this study area is used to figure out the relationship between I-676 and property sales price. This is the main study area we use for our predictive model as well.
-   **North and South Split:** We split our main study area into areas North and South of I-676 (which we refer to as Callowhill and Chinatown, respectively, for simplicity). This allows us to see how the highway effect is felt differently across the highway.
...
```{r read_propertyCTFE, quiet = TRUE, results = 'hide'}
property_CT <- st_read("Dataset/property/property_CT_FE.geojson")
```
...
Below is the code we used to filter OPA properties to only include those which are 500m within a Philadelphia highway.
